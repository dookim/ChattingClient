...
import com.zoco.chatclient.common.Constants;
...
public class ClientThread extends Thread {
	...
	public void sendFinMessage() throws IOException {
		String msg = Constants.PROTOCOL + Constants.BEHAVIOUR_FIN + "//" + user.chatId;
		sayToServer(msg);
	}
	...
	private void sendAskMessage() throws IOException {
		String msg = Constants.PROTOCOL + Constants.BEHAVIOUR_ASK + "//" + user.chatId;
		sayToServer(msg);
	}
	...
	private void sendInitMessage(int lastReceivedIndex) throws IOException {
		String msg = Constants.PROTOCOL + Constants.BEHAVIOUR_INIT + "//" + user.chatId + "//" + lastReceivedIndex;
		sayToServer(msg);
	}
	 ...
	 */
	 public void sendConfirmMessage(int bookId, String oppositeChatId, int chattingIndex) throws IOException {
		String msg = Constants.PROTOCOL + Constants.BEHAVIOUR_CONFIRM + "//" + bookId + "//" + user.chatId + "//" + oppositeChatId + "//" + chattingIndex;
		sayToServer(msg);
	}
	 /**
	  * @throws IOException
